...
print(type(csv))                                                 #showing or reflect the data type
...
print(csv.sort_index(axis=0,ascending=False))                    #sort index means index wise sort and ascending use for not required for ascending that's why False otherWise True
