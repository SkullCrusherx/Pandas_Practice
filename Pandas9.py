...
#csv.interpolate(limit_direction='forward/backward/both',inplace=True)                          # fil data by forward linear wise back word linear wise and both

#csv.interpolate().ffill()
#csv.interpolate().bfill()
