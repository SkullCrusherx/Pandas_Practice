...
print(csv.dropna(subset=["Day"]))                   # All 'Nan' drop column wise bcz subset = ['column name']
...
csv.ffill(axis=0/1)                                 # Fill data forward with data axis 0 means row and column means 1
csv.bfill(axis=0/1)                                 # Fill data before data with using axis 0 means row and column means 1
