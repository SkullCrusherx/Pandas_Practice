...
print("*")
print(csv.loc[["BHK","Price"][1,3]])                                  #here ican get data using which data actually need using comma [["Colum name1","Colum name2"][5]Row]
print(csv.loc["Price"][1:5])                                         #here ican get data using which data actually need using slicing [column_name][1:5]Row]
